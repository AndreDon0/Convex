...
class TestVoid(TestCase):
    ...
    # Количество пересечений пустоты с кругом единичного радиуса ноль
    def test_IWC(self):
        self.assertEqual(self.f.IWC(), 0)
...
class TestPoint(TestCase):
    ...
    # Количество пересечений точки с кругом единичного радиуса один или ноль
    def test_IWC1(self):
        self.assertEqual(self.f.IWC(), 1)

    def test_IWC2(self):
        p = Point(R2Point(1.0, 1.0))
        self.assertEqual(p.IWC(), 0)
...
class TestSegment(TestCase):
    ...
    # Проверка количества пересечений точки с кругом единичного радиуса
    def test_IWC1(self):
        self.assertEqual(self.f.IWC(), inf)

    def test_IWC2(self):
        a = R2Point(-1.0, 1.0)
        b = R2Point(1.0, 1.0)
        self.assertEqual(Segment(a, b).IWC(), 1)

    def test_IWC3(self):
        a = R2Point(2.0, 2.0)
        b = R2Point(-2.0, 2.0)
        self.assertEqual(Segment(a, b).IWC(), 0)
...
class TestPolygon(TestCase):
    ...
    def test_IWC2(self):
        p = R2Point(12313.0, -12131.0)
        self.assertEqual(self.f.add(p).IWC(), inf)
    ...
    def test_IWC3(self):
        ...
        c = R2Point(2, 2)
        d = R2Point(2, -2)
        p = Polygon(a, b, c).add(d)
        self.assertEqual(p.IWC(), 1)
